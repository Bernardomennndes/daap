...
echo "──────────────────────────"
echo "  ./scripts/check-requirements.sh    # Verificar pré-requisitos do sistema"
echo "  ./scripts/validate-env.sh          # Validar configuração .env"
echo "  ./scripts/setup-info.sh            # Ver resumo da configuração"
echo ""

echo "🚀 2. DEPLOY E GERENCIAMENTO"
echo "────────────────────────────"
echo "  ./scripts/deploy.sh                # Deploy com 3 instâncias (padrão)"
echo "  ./scripts/deploy.sh 5              # Deploy com 5 instâncias específicas"
echo "  ./scripts/scale.sh 8               # Escalar para 8 instâncias"
echo "  ./scripts/scale.sh 2               # Reduzir para 2 instâncias"
echo ""

echo "📊 3. MONITORAMENTO"
echo "───────────────────"
echo "  ./scripts/monitor.sh               # Status completo do sistema"
echo "  ./scripts/logs.sh                  # Logs de todos os serviços"
echo "  ./scripts/logs.sh reviews          # Logs apenas do reviews-service"
echo "  ./scripts/logs.sh cache            # Logs apenas do cache-service"
echo "  ./scripts/logs.sh traefik          # Logs do load balancer"
echo ""

echo "🧪 4. TESTES"
echo "────────────"
echo "  ./scripts/load-test.sh             # Teste básico (100 req, 10 concurrent)"
echo "  ./scripts/load-test.sh 500 20      # Teste intenso (500 req, 20 concurrent)"
